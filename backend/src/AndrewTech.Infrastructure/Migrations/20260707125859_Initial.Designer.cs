...
namespace AndrewTech.Infrastructure.Migrations
{
    ...
    [Migration("20260707125859_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AndrewTech.Domain.Modules.Issue", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("AndrewTech.Domain.Modules.Module", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid")
                        .HasColumnName("id");
            ...
            modelBuilder.Entity("AndrewTech.Domain.Modules.Issue", b =>
                {
                    b.HasOne("AndrewTech.Domain.Modules.Module", null)
                        .WithMany("Issues")
                        .HasForeignKey("module_id")
                        .HasConstraintName("fk_issues_modules_module_id");

                    b.HasOne("AndrewTech.Domain.Modules.Issue", "ParentIssue")
                        .WithMany("SubIssues")
                        .HasForeignKey("parent_id")
                        .OnDelete(DeleteBehavior.NoAction)
                        .HasConstraintName("fk_issues_issues_parent_id");

                    b.OwnsOne("AndrewTech.Domain.Modules.IssueDetails", "Details", b1 =>
                        {
                            ...
                            b1.OwnsMany("AndrewTech.Domain.Modules.File", "Files", b2 =>
                                {
